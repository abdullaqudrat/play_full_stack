...
const searchArtistTracks = (event) => {
  event.preventDefault()
    let artistName = document.getElementById('searchField').value;
    fetch(`https://api.musixmatch.com/ws/1.1/track.search?q_artist=${artistName}&page_size=10&page=1&s_track_rating=desc&apikey=d54f2a729ccc9c98bfdf337e42a89ce9`
    )
